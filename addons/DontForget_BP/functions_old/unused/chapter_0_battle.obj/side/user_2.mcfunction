execute if score c0_side_battle op_timer matches 0 if score c0_side_battle t.c0_side matches 1 run setblock 144 43 -93 redstone_torch
...
execute if score c0_side_battle op_timer matches 0 if score c0_side_battle t.c0_side matches 1 run function resource/battle/chapter_0_battle.obj/side/wave/Wave2
...
execute if score c0_side_battle op_timer matches 0 if score c0_side_battle t.c0_side matches 5..9 if score enemy_amount c.c0_side matches 0 run scoreboard players set c0_side_battle f.battle 3
