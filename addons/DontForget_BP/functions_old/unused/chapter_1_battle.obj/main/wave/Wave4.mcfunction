...
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Slime3
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie2
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie4
...
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie6
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton3
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Slime3
...
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie5
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie9
...
execute if score player_amount c.c1_main matches 3.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie7
execute if score player_amount c.c1_main matches 3.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton3
execute if score player_amount c.c1_main matches 4.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie7
execute if score player_amount c.c1_main matches 4.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton3
...
scoreboard players random @e[tag=enemy,tag=enemy_in_c1_main] e.spawn_timer 5 20
scoreboard players add @e[tag=enemy_skeleton,tag=enemy_in_c1_main] e.spawn_timer 8
scoreboard players add @e[tag=enemy_zombie,tag=enemy_in_c1_main] e.spawn_timer 2
scoreboard players add @e[tag=enemy_armored,tag=enemy_in_c1_main] e.spawn_timer 4
scoreboard players add @e[tag=enemy_leader,tag=enemy_in_c1_main] e.spawn_timer 8
scoreboard players add @e[tag=enemy_killer,tag=enemy_in_c1_main] e.spawn_timer 4
scoreboard players add @e[tag=enemy_small_slime,tag=enemy_in_c1_main] e.spawn_timer -2
...
execute as @r[tag=game_player,tag=player_in_c1_main] at @s run scoreboard players random @e[c=3,tag=enemy,tag=!enemy_leader,tag=!enemy_large_slime] e.spawn_timer 5 10
