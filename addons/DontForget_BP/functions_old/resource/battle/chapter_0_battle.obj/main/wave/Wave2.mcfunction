...
execute if score value c.player_amount matches 1.. run execute positioned 89 45 -24 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie1
execute if score value c.player_amount matches 1.. run execute positioned 89 45 -24 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie4
...
execute if score value c.player_amount matches 3.. run execute positioned 89 45 -24 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie2
...
scoreboard players random @e[family=monster,x=89,y=45,z=-24,r=1] e.spawn_timer 4 10
scoreboard players set @r[family=monster,type=!player,c=1,x=89,y=45,z=-24,r=1] e.spawn_timer 6
