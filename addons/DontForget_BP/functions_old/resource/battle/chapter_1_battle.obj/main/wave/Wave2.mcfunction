...
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton1
...
execute if score player_amount c.c1_main matches 3.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton2
...
execute as @r[tag=game_player,tag=player_in_c1_main] at @s run scoreboard players random @e[c=3,tag=enemy,tag=!enemy_leader] e.spawn_timer 5 7
