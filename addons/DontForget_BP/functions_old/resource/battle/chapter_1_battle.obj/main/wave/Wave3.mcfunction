...
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie9
execute if score player_amount c.c1_main matches 1.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton2
...
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie4
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie6
execute if score player_amount c.c1_main matches 2.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Skeleton3
execute if score player_amount c.c1_main matches 3.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie3
execute if score player_amount c.c1_main matches 3.. run execute positioned 206 57 84 run function resource/entity/enemy_spawner.obj/spawn_custom/Zombie3
...
scoreboard players random @e[tag=enemy,tag=enemy_in_c1_main] e.spawn_timer 7 15
...
execute as @r[c=2,tag=game_player,tag=player_in_c1_main] at @s run scoreboard players random @e[c=2,tag=enemy,tag=!enemy_leader] e.spawn_timer 5 7
