...
scoreboard players set EVENT_GP_GameBegin_CountEnderEye flag 0
scoreboard players set EVENT_GP_GameBegin_PortalAnim flag -1
scoreboard players set EVENT_GP_GameBegin_PortalAnim timer -1
scoreboard players set EVENT_GP_GameBegin flag 1

#DEBUG OUTPUT
tellraw @a[tag=debugger] {"rawtext":[{"translate":"text.dialog.debug.prefix"},{"translate":"text.dialog.debug.run_function"},{"text":"dontforget/event/gameplay/game_begin/Portal_Anim_Reset"}]}