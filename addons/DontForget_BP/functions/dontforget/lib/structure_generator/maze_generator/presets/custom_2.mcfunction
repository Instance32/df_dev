...
scoreboard players set MazeGeneratorLoadHallwayType condition 1
...
scoreboard players set MazeGeneratorCheckLayer counter 3
...
scoreboard players set MazeGeneratorLoadLayer counter 2
...
scoreboard players set MazeGeneratorLoadExtraTryTime counter 2
...
scoreboard players set MazeGeneratorLoadExtraTotalTime counter 105
...
scoreboard players set MazeGeneratorLoadHallwayTotalTime counter 105
...
scoreboard players set MazeGeneratorLoadRoomTotalTime counter 10
