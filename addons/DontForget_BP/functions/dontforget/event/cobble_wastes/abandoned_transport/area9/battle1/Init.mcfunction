scoreboard players set EV_CW_ABTP_Area9_Battle1 step 1
scoreboard players set EV_CW_ABTP_Area9_Battle1_Trigger1 step 0
...
scoreboard players set EV_CW_ABTP_Area9_Battle1_CurrentWaveEnemyKilled counter -1
...
#DEBUG OUTPUT
tellraw @a[tag=debugger] {"rawtext":[{"translate":"text.dialog.debug.prefix"},{"translate":"text.dialog.debug.run_function"},{"text":"dontforget/event/cobble_wastes/abandoned_transport/area9/battle1/Init"}]}