scoreboard players set EV_CW_BGN_Area3_Battle1 step 1
scoreboard players set EV_CW_BGN_Area3_Battle1_Trigger1 step 0
...
scoreboard players set EV_CW_BGN_Area3_Battle1_CurrentWaveEnemyKilled counter -1
